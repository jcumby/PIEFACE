# -*- coding: utf-8 -*-
#
# pieface documentation build configuration file, created by
...
.. |article| replace:: James Cumby & J. Paul Attfield, *Ellipsoidal Analysis of Coordination Polyhedra*, Nature Communications (2017).
...
# of the sidebar.
#
html_logo = 'images/high_res_icon.png'
...
# the title page.
#
latex_logo = 'images/high_res_icon.png'
